    ...
    <div class="registerDiv">
        ...
        <table class="registerTable" align="center">
            <tr>
                ...
                <td  class="registerTableRightTD"><input id="nickName" name="nickName" placeholder="昵称一旦设置成功，无法修改" > </td>
            </tr>
            <tr>
                <td class="registerTableLeftTD">手机号</td>
                <td  class="registerTableRightTD"><input id="userName" name="userName" placeholder="手机号一旦设置成功，无法修改" > </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="registerTableLeftTD"><img alt="验证码" onclick="this.src='/defaultKaptcha?d='+new Date()*1" src="/defaultKaptcha"></td>
                <td class="registerTableRightTD"><input id="verification" type="verification"   placeholder="请输入验证码" > </td>
            </tr>
...
<div id="footer"  class="footer" style="display: block;">
    ...
    <div id="footer_desc" class="footer_desc">
        ...
        <div class="descColumn">
            <span class="descColumnTitle">考拉保障</span>
        ...
        <div class="descColumn">
            ...
            <a href="#nowhere" >考拉智库</a>
            <a href="#nowhere" >考拉规则</a>
            <a href="#nowhere" >物流服务</a>
            <a href="#nowhere" >喵言喵语</a>
            <a href="#nowhere" >运营服务</a>
        </div>
        <div class="descColumn">
            <span class="descColumnTitle">手机考拉</span>
    ...
    <div id="copyright" class="copyright">
        <div class="coptyrightMiddle">
            <div class="white_link" >
                <a href="#nowhere" style="padding-left:0px" >关于考拉</a>
